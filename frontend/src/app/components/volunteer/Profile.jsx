...
<div className="formGroups">
    ...
    <h3>Medical History</h3>
            ...
            <ul className="questions">
                ...
                <input type="text" defaultValue={p.current}name="current" />
                </li>
                <li>
    ...
    <h3>Social History</h3>
            ...
            <ul className="questions">
                ...
                <input type="text" defaultValue={p.alcohol}name="alcohol" />
                </li>
    ...
    <h3>Lifestyle Factors</h3>
            ...
            <ul className="questions">
                ...
                <input type="text"defaultValue={p.exercise} name="exercise" />
                </li>
            ...
            <button style={{marginTop: "1em"}}className="save btn syb" onSubmit={handleSubmit}>Save</button>
